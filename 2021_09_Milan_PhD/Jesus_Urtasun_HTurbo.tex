...
\begin{frame}
	...
	\center{PhD seminar - Milan, September 2021}
...
\begin{frame}
	...
	\begin{figure}
		\includegraphics[width = 9.5 cm]{plots/part_I/lhc_measurements.png}
	\end{figure}

\end{frame}

% QCD and collider physics - Factorization theorem
\begin{frame}
	...
	\begin{figure}
		\includegraphics[width = 7 cm]{plots/part_I/factorization_1.png}
	\end{figure}
...
% and collider physics - Partonic cross section
\begin{frame}
	...
	\begin{figure}
		\includegraphics[width = 7 cm]{plots/part_I/factorization_2.png}
	\end{figure}
...
% QCD and collider physics - QCD coupling
\begin{frame}

	\frametitle{QCD and collider physics}
	\framesubtitle{QCD coupling}
	...
	\begin{columns}	
		...
		\begin{figure}
			\includegraphics[width = 5 cm]{plots/part_I/qcd_coupling.png}
		\end{figure}
...
% QCD and collider physics - Perturbative QCD
\begin{frame}
	...
	\begin{columns}
		...
		\column{0.45\textwidth}
		\begin{figure}[!htb]
			\includegraphics[width = 5 cm]{plots/part_I/factorization_3.png}
		\end{figure}
...
\begin{frame}
	...
	\column{0.45\textwidth}
	\begin{figure}[!htb]
		\includegraphics[width = \linewidth]{plots/part_II/qcd_corrections.png}
	\end{figure}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{figure}
			\includegraphics[width = 4cm]{plots/part_II/qT_diagram.png}
		\end{figure}
	...
	\begin{figure}
		\includegraphics[width = 7.5cm]{plots/part_II/qT_logs_table.png}
	\end{figure}
...
\begin{frame}
	...
	\center{\color{blue}Accurate predictions for Higgs boson at the LHC}
...
% Results - Benchmark HRes - resummed
\begin{frame}
...
% Results - Benchmark HRes - fixed order
\begin{frame}
	...
	\begin{itemize}
		\item Represent fiducial (RHS) phase space - HRes vs HTurbo {\color{darkgreen}$\checkmark$} 
		\item Agreement up to fixed order NL0 $\longrightarrow$ {\color{blue}ready for N$^{3}$LL}
	\end{itemize}

\end{frame}

% Results - Benchmark HRes - finite
\begin{frame}
	...
	\begin{itemize}
		\item Represent fiducial phase space - HRes vs HTurbo {\color{darkgreen}$\checkmark$} 
