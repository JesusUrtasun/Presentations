...
\begin{frame}
	...
	\begin{equation}
		d\sigma^{\textbf{H}}_{\textrm{(N)NLL+(n)LO}} = 
		d\sigma^{\textbf{(res.)}}_{\textrm{(N)NLL}} - 
		d\sigma^{\textbf{(asy.)}}_{\textrm{(N)LO}} + 
		d\sigma^{\textbf{(f.o.)}}_{\textrm{(N)LO}} \; , \nonumber
	\end{equation}

	\begin{align}
		d\sigma^{\textbf{(res.)}}_{\textrm{(N)NLL}} &= \hat{\sigma}^{\textrm{H}}_{\textrm{LO}} \times \mathcal{H}_{\textrm{(N)LO}} \times \exp{\mathcal{G}}_{\textrm{(N)NLL}} \; , \nonumber \\
